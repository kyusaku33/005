...
def main(eval):
    ...
    args.epoch = 2
    args.batch_size = 4
    args.dataset = "images/train"
    args.style_image = "style/train"
    args.save_model_dir = ""
    args.cuda = 0
    args.seed = 42
    ...
    args.content_image = "images/content-images/chicago.jpg"
    args.output_image = "images/output-images/test2.jpg"
    args.model = "saved_models/candy.pth"
    args.export_onnx = ""  
